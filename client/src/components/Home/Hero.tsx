...
const Hero = () => {
    return (
        <section className='relative overflow-hidden min-h-[540px] mb-10 rounded-3xl flex items-center'>
            <img src={heroSectionData.hero_image} alt="Hero" className='absolute inset h-full w-full object-cover' />
            ...
            <div className='relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full'>
                <div className='max-w-xl xl:pl-10'>
                    ...
                    <h1 className='font-serif text-4xl sm:text-5xl lg:text-7xl text-white leading-tight mb-5'>Nourish your home with <span className='text-orange-300'>Earth's finest.</span></h1>
